...
public class GetAssetPriceByDateQueryHandler : IRequestHandler<GetAssetPriceByDateQuery, List<GetAssetPriceByDateQueryViewModel>>
    {
        ...
        public async Task<List<GetAssetPriceByDateQueryViewModel>> Handle(GetAssetPriceByDateQuery request, CancellationToken 
            cancellationToken)
        {
